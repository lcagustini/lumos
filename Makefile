all: gfx
	mkdir -p bin
	/opt/devkitpro/devkitARM/bin/arm-none-eabi-gcc -mthumb-interwork -mthumb -specs=gba.specs src/main.c src/bios.s src/gfx/*.s -o bin/main.o -O2 -Wno-int-conversion -g
